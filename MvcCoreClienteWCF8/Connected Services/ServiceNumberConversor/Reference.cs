...
namespace ServiceNumberConversor
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://www.dataaccess.com/webservicesserver/", ConfigurationName="ServiceNumberConversor.NumberConversionSoapType")]
    public interface NumberConversionSoapType
    {
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceNumberConversor.NumberToWordsResponse> NumberToWordsAsync(ServiceNumberConversor.NumberToWordsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceNumberConversor.NumberToDollarsResponse> NumberToDollarsAsync(ServiceNumberConversor.NumberToDollarsRequest request);
    }
    ...
    public partial class NumberToWordsRequest
    {
        ...
        public ServiceNumberConversor.NumberToWordsRequestBody Body;
        
        public NumberToWordsRequest()
        {
        }
        
        public NumberToWordsRequest(ServiceNumberConversor.NumberToWordsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToWordsResponse
    {
        ...
        public ServiceNumberConversor.NumberToWordsResponseBody Body;
        
        public NumberToWordsResponse()
        {
        }
        
        public NumberToWordsResponse(ServiceNumberConversor.NumberToWordsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsRequest
    {
        ...
        public ServiceNumberConversor.NumberToDollarsRequestBody Body;
        
        public NumberToDollarsRequest()
        {
        }
        
        public NumberToDollarsRequest(ServiceNumberConversor.NumberToDollarsRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class NumberToDollarsResponse
    {
        ...
        public ServiceNumberConversor.NumberToDollarsResponseBody Body;
        
        public NumberToDollarsResponse()
        {
        }
        
        public NumberToDollarsResponse(ServiceNumberConversor.NumberToDollarsResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public interface NumberConversionSoapTypeChannel : ServiceNumberConversor.NumberConversionSoapType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.2.0-preview1.23462.5")]
    public partial class NumberConversionSoapTypeClient : System.ServiceModel.ClientBase<ServiceNumberConversor.NumberConversionSoapType>, ServiceNumberConversor.NumberConversionSoapType
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceNumberConversor.NumberToWordsResponse> ServiceNumberConversor.NumberConversionSoapType.NumberToWordsAsync(ServiceNumberConversor.NumberToWordsRequest request)
        {
            return base.Channel.NumberToWordsAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceNumberConversor.NumberToWordsResponse> NumberToWordsAsync(ulong ubiNum)
        {
            ServiceNumberConversor.NumberToWordsRequest inValue = new ServiceNumberConversor.NumberToWordsRequest();
            inValue.Body = new ServiceNumberConversor.NumberToWordsRequestBody();
            inValue.Body.ubiNum = ubiNum;
            return ((ServiceNumberConversor.NumberConversionSoapType)(this)).NumberToWordsAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceNumberConversor.NumberToDollarsResponse> ServiceNumberConversor.NumberConversionSoapType.NumberToDollarsAsync(ServiceNumberConversor.NumberToDollarsRequest request)
        {
            return base.Channel.NumberToDollarsAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceNumberConversor.NumberToDollarsResponse> NumberToDollarsAsync(decimal dNum)
        {
            ServiceNumberConversor.NumberToDollarsRequest inValue = new ServiceNumberConversor.NumberToDollarsRequest();
            inValue.Body = new ServiceNumberConversor.NumberToDollarsRequestBody();
            inValue.Body.dNum = dNum;
            return ((ServiceNumberConversor.NumberConversionSoapType)(this)).NumberToDollarsAsync(inValue);
        }
